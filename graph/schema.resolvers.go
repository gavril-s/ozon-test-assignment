...
func (r *queryResolver) Posts(ctx context.Context, first *int, after *string) ([]*model.PostSnippetConnection, error) {
	panic(fmt.Errorf("not implemented: Posts - posts"))
}

// Post is the resolver for the post field.
func (r *queryResolver) Post(ctx context.Context, id string, commentsFirst *int, commentsAfter *string) (*model.Post, error) {
